...
<style>
    ...
    .btn-submit:hover { background: #4A6B4C; border-color: #4A6B4C; }
...
<div class="form-card">
    <div class="form-header">
        ...
        <div>
            <div class="form-title">Tambah Anggota Baru</div>
            <div class="form-subtitle">Isi data anggota perpustakaan dengan lengkap</div>
        </div>
    </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           placeholder="NIM atau Nomor KTP"
                           >
                    @error('nomor_induk')
                        <div class="form-error">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
