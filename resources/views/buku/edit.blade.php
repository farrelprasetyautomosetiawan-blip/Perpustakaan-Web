    ...
    <div class="form-card">
        <div class="form-header">
            ...
            <div>
                ...
                <p class="form-subtitle">Perbarui informasi buku</p>
            </div>
        </div>
            ...
            <form action="{{ route('buku.update', $buku->id) }}" method="POST">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_buku" class="form-input" placeholder="Contoh: BK-001" value="{{ old('kode_buku', $buku->kode_buku) }}">
                        @error('kode_buku')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="isbn" class="form-input" placeholder="Contoh: 978-602-0000-00-0" value="{{ old('isbn', $buku->isbn) }}">
                    </div>

                    <div class="form-group full-width">
                        <label class="form-label">Judul Buku <span class="required">*</span></label>
                        <input type="text" name="judul" class="form-input" placeholder="Masukkan judul buku" value="{{ old('judul', $buku->judul) }}">
                        @error('judul')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="penulis" class="form-input" placeholder="Nama penulis" value="{{ old('penulis', $buku->penulis) }}">
                        @error('penulis')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="penerbit" class="form-input" placeholder="Nama penerbit" value="{{ old('penerbit', $buku->penerbit) }}">
                        @error('penerbit')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="tahun_terbit" class="form-input" placeholder="Contoh: 2024" value="{{ old('tahun_terbit', $buku->tahun_terbit) }}">
                        @error('tahun_terbit')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_halaman" class="form-input" placeholder="Contoh: 256" value="{{ old('jumlah_halaman', $buku->jumlah_halaman) }}">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <select name="kategori" class="form-select">
                            ...
                            <option value="Ilmu Pengetahuan" {{ old('kategori', $buku->kategori) == 'Ilmu Pengetahuan' ? 'selected' : '' }}>Ilmu Pengetahuan</option>
                            ...
                            <option value="Seni" {{ old('kategori', $buku->kategori) == 'Seni' ? 'selected' : '' }}>Seni</option>
                            <option value="Sastra" {{ old('kategori', $buku->kategori) == 'Sastra' ? 'selected' : '' }}>Sastra</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="stok" class="form-input" placeholder="Jumlah stok" value="{{ old('stok', $buku->stok) }}">
                        @error('stok')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="rak" class="form-input" placeholder="Contoh: Rak A-1" value="{{ old('rak', $buku->rak) }}">
                    </div>

                    <div class="form-group full-width">
                        <label class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" class="form-input" placeholder="Masukkan deskripsi buku (opsional)">{{ old('deskripsi', $buku->deskripsi) }}</textarea>
                    </div>
                </div>
